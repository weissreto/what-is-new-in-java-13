...
{
  /**
   * Example call to new method {@link StandardJavaFileManager#getJavaFileObjectsFromPaths(Collection)}.
   * @since 13
   * @see StandardJavaFileManager#getJavaFileObjectsFromPaths(Collection)
   */
